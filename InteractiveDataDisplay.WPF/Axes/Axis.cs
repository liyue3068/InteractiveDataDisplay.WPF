...
namespace InteractiveDataDisplay.WPF
{
    ...
    public class Axis : Panel
    {
        ...
        private readonly TicksProvider ticksProvider;
        private readonly Path majorTicksPath;
        private readonly Path minorTicksPath;
        ...
        public Axis()
        {
            ...
            BindingOperations.SetBinding(majorTicksPath, Path.StrokeProperty, new Binding("Foreground") { Source = this, Mode = BindingMode.OneWay });
            BindingOperations.SetBinding(minorTicksPath, Path.StrokeProperty, new Binding("Foreground") { Source = this, Mode = BindingMode.OneWay });
        ...
        public static readonly DependencyProperty TicksProperty =
            DependencyProperty.Register("Ticks", typeof(IEnumerable<double>), typeof(Axis), new PropertyMetadata(Array.Empty<double>()));
        ...
        private TickChange CheckLabelsArrangement(Size axisSize, IEnumerable<FrameworkElement> inputLabels, double[] inputTicks)
        {
            ...
            var actualLabels3 = actualLabels2.Select(el => new { el.Label, Tick = inputTicks[el.Index] });
