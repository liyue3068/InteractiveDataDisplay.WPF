...
namespace InteractiveDataDisplay.WPF
{
    ...
    public class DataSeries : DependencyObject
    {
        ...
        private static void OnDescriptionPropertyChanged(object sender, DependencyPropertyChangedEventArgs e)
        {
            ...
            ds.DataChanged?.Invoke(ds, new EventArgs());
        }
        ...
        private object GetFirstUnconvertedDataItem()
        {
            ...
            {
                if (Data is IEnumerable ie && !(Data is string))
                {
        ...
        public int Length
        {
            get
            {
                ...
                {
                    if (Data is IEnumerable ie && !(Data is string)) // String is also IEnumerable, but we tread them as scalars
    ...
    public class DataCollection : ObservableCollection<DataSeries>
    {
        ...
        {
            return TryGetValue(name, out DataSeries dummy);
        }
        ...
        public int XSeriesNumber
        {
            get
            {
                TryGetValue("X", out DataSeries dummy);
                if (dummy == null)
                    return -1;
                else
        ...
        public DataSeries this[string name]
        {
            get
            {
                if (TryGetValue(name, out DataSeries result))
                    return result;
                else
                    return null;
            }
        ...
        protected override void OnCollectionChanged(System.Collections.Specialized.NotifyCollectionChangedEventArgs e)
        {
            ...
            OnPropertyChanged(new PropertyChangedEventArgs(nameof(Emitted)));
        }
    ...
    public class MarkerViewModel : INotifyPropertyChanged
    {
        ...
        public object this[string name]
        {
            get
            {
                ...
                // Get value
                object value = null;
                if (dataSeries.Data is Array arr)
                {
                    if (row < arr.Length)
                ...
                {
                    if (dataSeries.Data is IEnumerable ie && !(dataSeries.Data is string)) // String is also IEnumerable
                    {
