...
namespace InteractiveDataDisplay.WPF
{
    ...
    {
        private readonly List<DynamicMarkerViewModel> models = new List<DynamicMarkerViewModel>();
        ...
        private readonly DispatcherTimer idleTask = new DispatcherTimer();
        ...
        private readonly Subject<RenderCompletion> renderCompletion = new Subject<RenderCompletion>();
        /// <summary>
        ...
        protected override Size MeasureOverride(Size availableSize)
        {
            ...
            foreach (UIElement elt in Children)
            {
                if (elt is Image img)
                {
                    if (img.Tag is Batch batch && batch.Image == elt) // Special algorithm for snapshot image
                    {
    ...
    {
        private readonly int markerCount;
        /// <summary>
