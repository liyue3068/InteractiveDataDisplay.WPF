...
namespace InteractiveDataDisplay.WPF
{
    ...
    public abstract class PlotBase : Panel
    {
        ...
        private readonly List<PlotBase> dependantsField = new List<PlotBase>();
        /// <summary>
        ...
        private readonly Subject<PlotCompositionChange> compositionChange = new Subject<PlotCompositionChange>();
        ...
        public static new readonly DependencyProperty ClipToBoundsProperty =
        ...
        internal void Fit(DataRect plotBounds, Size screenSize)
        {
            ...
            EnumAll(p =>
            {
                p.PlotTransformChanged?.Invoke(this, EventArgs.Empty);
            });
        }
